...
/**
 * Firstsortsectioncount filter form base class.
 *
 ...
 */
class BaseFirstsortsectioncountFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('firstsortsectioncount_filters[%s]');
